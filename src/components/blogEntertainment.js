...
class Entertainment extends React.Component {
    ...
    renderList(){
        const sports = this.props.streams?.slice(0, 40).filter((stream) => stream.category === 'entertainment')
        return  sports?.map((blog, index) => 
                    
            <div key={index} className="d-md-flex px-4 mb-4 shadow-sm">
                <div className="mb-4">
    ...
    render() {
        ...
        <>
            ...
            <div className="d-flex text-wrap mb-5">
                <div className="col">
...
export default connect(mapStateToProps, {Fetch_blogs})(Entertainment);
